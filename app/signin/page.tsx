...
export default function SignInPage() {
  ...
  const { signIn, role } = useApp();
  const router = useRouter();

  const handleSignIn = (e: React.FormEvent, provider?: string) => {
    e.preventDefault();
        ...
        <div className="mx-auto max-w-md">
          <Card>
            <CardHeader className="space-y-1 text-center">
              ...
              <CardTitle className="text-2xl">Welcome to FixMate</CardTitle>
              <CardDescription>
                Sign in to access instant help and support
              </CardDescription>
            </CardHeader>
