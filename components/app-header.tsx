          ...
          <div className="flex items-center gap-6">
            ...
            >
              <div
                className={
                  resolvedTheme === "dark"
                    ? "relative h-12 w-8 overflow-hidden" // portrait-ish
                    : "relative h-12 w-12 overflow-hidden" // more square
                }
              >
                {mounted && (
                  ...
                  <Image
                    src={
                      resolvedTheme === "dark"
                        ? "/ri-dark-theme-logo-portrait.webp"
                        : "/ri-light-theme-logo-portrait.png"
                    }
                    alt="FixMate logo"
                    fill
                    priority
                    className={
                      resolvedTheme === "dark"
                        ? "object-contain"
                        : "object-cover" // helps remove the huge padding effect
                    }
                  />
                )}
              </div>
            ...
            <nav className="hidden md:flex items-center gap-1">
              {getLinks().map((link) => {
                const Icon: LucideIcon | null =
                  "icon" in link ? (link.icon as LucideIcon) : null;
                return (
